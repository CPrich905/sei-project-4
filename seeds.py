...
with app.app_context():
    ...
    jacket_feta = Recipe(
        ...
        instructions='''1. Heat oven to 220C/200C fan/ gas 6. Prick the potato all over with a fork and bake for 1 hr until it is golden outside and soft inside. Mix 1 tsp olive oil with the garlic salt. Cut a deep cross into the top of the jacket, drizzle the garlic oil into the cross and rub it all over the outside. Return to the oven and bake for 15 mins more until the edges are golden and crispy.
    ...
    veg_tagine = Recipe(
        ...
        instructions='''1. Heat the oil in a large frying pan and fry the onion over a medium heat for 3 mins. Add the garlic and butternut squash, and cook for a further 7 mins.
